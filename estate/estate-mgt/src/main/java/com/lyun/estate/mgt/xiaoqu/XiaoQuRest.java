...
public class XiaoQuRest {
    ...
    public int updateXiaoQu(@RequestParam long id,
                                        ...
                                        @RequestParam(required = false) int buildedYear,
                                        @RequestParam(required = false) int developYear,
                                        ...
                                        @RequestParam(required = false) int buildings,
                                        @RequestParam(required = false) int houses,
