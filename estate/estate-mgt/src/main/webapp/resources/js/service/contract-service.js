...
define(contextPath + '/js/service/contract-service.js',
    ['main-app', contextPath + '/js/service/propertyvisit-service.js', contextPath + '/js/service/request-service.js'],
    function (mainApp, PropertyVisitService, RequestService) {
        var ContractService = {};
