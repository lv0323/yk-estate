                                        ...
                                        <div class="media-body">
                                            <div class="col-lg-12 col-md-12 col-sm-12 app-item">
                                                ...
                                                <div class="clearfix m-t-10 text-muted f16">
                                                    ...
                                                    <span class="m-l-10" ng-show="applicationDTO.application.status.name != 'NEW'">审批意见: <span ng-class="{'text-success':applicationDTO.application.status.name=='APPROVED','text-danger':applicationDTO.application.status.name=='REJECTED'}">{{applicationDTO.application.reviewerComments}}</span>
                                                </div>
                                            </div>
                                            <div class="app-operation">
                                                ...
                                                <div class="text-right m-t-15">
                                                    <a href="" class="btn btn-success app-btn" ng-show="applicationDTO.application.status.name == 'NEW'" ng-click="approveApplication(applicationDTO.application.id)">通过</a>
                                                    <a href="" class="btn btn-danger app-btn" ng-show="applicationDTO.application.status.name == 'NEW'" ng-click="rejectApplication(applicationDTO.application.id)">拒绝</a>
                                                    <a href="" class="btn btn-default app-btn" ng-show="applicationDTO.application.status.name == 'NEW'" ng-click="closeApplication(applicationDTO.application.id)">关闭</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
