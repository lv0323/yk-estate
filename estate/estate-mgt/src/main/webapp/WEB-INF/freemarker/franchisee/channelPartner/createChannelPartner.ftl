                                ...
                                <div class="page">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <select id="companyListDrop">
                                                    ...
                                                    <option ng-repeat="company in companyList" ng-value="company.id" repeat-done="initChosen('#companyListDrop', 'companyId')">{{company.name}}</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="customerContact" type="text" class="form-control" placeholder="负责人手机">
                                            </div>
                                        </div>
                                        <hr>
