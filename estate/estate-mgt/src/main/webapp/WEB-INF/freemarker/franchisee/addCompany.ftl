                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-4">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right" id="addCompanyStartDate" placeholder="请填入起始日期">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-4 col-sm-4">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right" id="addCompanyEndDate" placeholder="请填入截止日期">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
