                            ...
                            <table class="list table table-bordered table-hover dataTable no-footer" ng-cloak>
                                ...
                                <tr ng-repeat="approval in ctrl.approvalList">
                                    ...
                                    <td ng-if="ctrl.filter.type === 'SIGNING'" >
                                        <label class="badge" ng-class="{'badge-success':approval.status.name == 'APPROVED',
                                                           'badge-danger':approval.status.name == 'REJECTED',
                                                           'badge-primary':approval.status.name == 'CREATED'}" ng-bind="approval.status.label"></label>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
