                                    ...
                                    <div class="items" ng-class="{'step2': ctrl.page.currentStep === ctrl.stepConfig.step2}">
                                        <div class="page" id="page1">
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2">
                                                    <select id="houseSubType" select-picker class="selectpicker show-menu-arrow form-control sel-news" ng-model="ctrl.data.subType" ng-change="ctrl.log()">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2">
                                                    <select id="houseDirection" select-picker class="selectpicker show-menu-arrow form-control" name="houseDirection" ng-model="ctrl.data.orientation" ng-change="ctrl.log()">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="pull-left col-lg-5 col-md-5 col-sm-5" id="tx3">
                                                    <div class="checkbox checkbox-nice checkbox-inline">
                                                        <input type="checkbox" name="houseCharacter" id="character10140" ng-model="ctrl.data.character.isOnly" ng-change="ctrl.log()"/>
