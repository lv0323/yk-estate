 ...
 */
public class LJSWordRenderer implements WordRenderer {
     ...
     * @param fonts
     */
    public LJSWordRenderer(List<Color> colors, List<Font> fonts) {
