...
public class AuditSqlProvider {
    public String findBySubjectIdDesc(Map<String, Object> params) {
        return new SQL().SELECT(
                "a.id, a.company_id, a.department_id, a.operator_id, a.subject, a.target_id, a.domain_type, a.content, a.create_time" +
