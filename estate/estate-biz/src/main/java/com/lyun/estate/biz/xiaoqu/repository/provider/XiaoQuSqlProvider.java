...
public class XiaoQuSqlProvider {
    ...
    public String findSellCommunityListByMap() {
        return new SQL() {{
            SELECT("community.id,community.name,xiaoQu.avg_price,community.longitude,community.latitude,'XIAO_QU' as domain_type,community.sell_house_count as building_counts");
